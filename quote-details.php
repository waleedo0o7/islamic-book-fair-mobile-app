...
<div class="page inner-page-layout quote-details">

    <div class="page-content p-0">

        <div class="quote-pref-wrapper bg-white mb-4 py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 m-auto">
                        ...
                        <div class="image-wrapper mb-3">
                            <img src="assets/images/thums/quote-0.jpg" class="quote-image">
                        </div><!-- image-wrapper -->
        ...
        <div class="related-wrapper mb-2">
            <div class="container">
                <h4 class="color-primary mb-4">  مقولات ذات صلة   </h4>
                <div class="row">

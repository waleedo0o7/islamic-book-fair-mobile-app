...
<div class="page inner-page-layout video-details">

    <div class="page-content p-0">

        <div class="video-pref-wrapper bg-white mb-4 py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 m-auto">
                        ...
                        <div class="row d-flex justify-content-center align-items-center mb-4">
                            ...
                            <div class="col-md-6">
                                <h4 class="color-primary video-title"> عنوان الفيديو .. </h4>
                            </div> <!-- col-md-6 -->
                        ...
                        <div class="image-wrapper mb-3">
                            ...
                            <!-- if uploaded video -->
                            <div class="co-video mb-4">
                                <video id="video-item" class="video-js vjs-default-skin" controls poster="assets/images/thums/">
        ...
        <div class="related-wrapper mb-2">
            <div class="container">
                <h4 class="color-primary mb-4"> فيديوهات ذات صلة </h4>
                <div class="row">
                    <?php foreach (range(0, 3) as $i) { ?>
                        <div class="col-6 col-md-3 mb-5">
                            <?php include 'shared-html/media-video-card.php' ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
